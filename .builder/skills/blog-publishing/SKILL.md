...
Use only approved brand voice profiles, taxonomy values, and Builder Media assets. Every post needs relevant imagery before it is considered preview-ready.
...
Fail closed on missing evidence, legal risk, or authorization; legal failures are never overridable.
